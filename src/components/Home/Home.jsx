	...
	return (
		<div className='flex flex-col justify-start items-center mt-[100px] lg:mt-[200px] w-[100vw] h-[calc(100vh-100px)] z-10 mx-auto'>
			<div className='flex flex-col lg:flex-row mx-auto px-auto'>
				<img className='xs:max-w-[150px] w-[150px] h-[150px] mx-auto xs:mt-5 lg:min-w-[450px] lg:w-[450px] lg:h-[450px] mb-auto' src={path} alt='diamond' />
				<div className='h-3/5 mt-5 mb-20 xs:p-10 lg:px-24'>
					<h2 className='max-w-[300px] mb-7 text-4xl uppercase font-thin tracking-wide text-gray-600 xs:text-center lg:text-left'>Bestseller</h2>
