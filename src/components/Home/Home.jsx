...
export const Home = () => {
	return (
		<div className='flex flex-col justify-start items-center mt-[100px] lg:mt-[200px] w-[100vw] z-10 mx-auto'>
			<div className='flex flex-col xl:flex-row mx-auto px-auto'>
				<img
					className='xs:max-w-[250px] w-[250px] h-[250px] mx-auto xs:mt-10 lg:min-w-[400px] lg:w-[400px] lg:h-[400px] mb-0 rounded-2xl'
					src={img}
					alt='diamond'
				/>
				<div className='h-3/5 mb-5 xs:p-10 xs:text-center xl:text-left lg:px-24'>
					<h2 className='mb-5 text-4xl uppercase font-thin tracking-wide text-purple-500'>Bestseller</h2>
					<h1 className='xs:text-center xl:text-left mb-5 text-3xl font-bold'>Oppenheimer Blue</h1>
					<p className='max-w-[400px] xs:text-center xl:text-left'>
