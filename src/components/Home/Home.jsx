				...
				<div className='flex flex-col lg:flex-row mx-auto px-auto'>
					...
					<div className='h-3/5 mb-5 xs:p-10 lg:px-24'>
						...
						<p className='max-w-[400px] text-left'>
							...
							Oppenheimer Blue is the largest fancy vivid blue diamond classified by the Gemological Institute of
							America ever sold at auction; it sold at Christie's in Geneva in May 2016 for US$50.6 million. Two
							telephone bidders had competed for the diamond; the identity of the purchaseris not publicly known.
						</p>
					</div>
				</div>
