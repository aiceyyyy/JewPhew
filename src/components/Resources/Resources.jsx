...
export const Resources = () => {
	return (
		<div className='w-screen h-[90vh] flex justify-center flex-wrap mx-auto'>
			<div className='max-w-[250px] mx-3 my-3 py-5 px-3 rounded-xl'>
				<h2 className='text-center text-2xl mb-5 italic'>Diamonds</h2>
			...
			<div className='max-w-[250px] mx-20 my-3 py-5 px-3 rounded-xl'>
				<h2 className='text-center text-2xl mb-5 italic'>Gold</h2>
			...
			<div className='max-w-[250px] mx-3 my-3 py-5 px-3 rounded-xl'>
				<h2 className='text-center text-2xl mb-5 italic'>Silver</h2>
